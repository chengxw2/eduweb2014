...
class gsp_eduweb2014_usuarioshow_gsp extends GroovyPage {
...
printHtmlPart(17)
if(true && (usuarioInstance?.cursousuarios)) {
printHtmlPart(24)
invokeTag('message','g',64,['code':("usuario.cursousuarios.label"),'default':("Cursousuarios")],-1)
printHtmlPart(25)
...
invokeTag('link','g',67,['controller':("cursoUsuario"),'action':("show"),'id':(c.id)],4)
printHtmlPart(27)
}
printHtmlPart(28)
}
...
printHtmlPart(31)
invokeTag('message','g',84,['code':("usuario.passwordExpired.label"),'default':("Password Expired")],-1)
printHtmlPart(32)
invokeTag('formatBoolean','g',86,['boolean':(usuarioInstance?.passwordExpired)],-1)
printHtmlPart(16)
}
printHtmlPart(33)
createTagBody(2, {->
...
invokeTag('link','g',94,['class':("edit"),'action':("edit"),'resource':(usuarioInstance)],3)
printHtmlPart(35)
...
invokeTag('form','g',97,['url':([resource:usuarioInstance, action:'delete']),'method':("DELETE")],2)
printHtmlPart(37)
})
...
public static final long LAST_MODIFIED = 1405119203107L
