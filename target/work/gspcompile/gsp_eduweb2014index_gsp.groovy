...
class gsp_eduweb2014index_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(5)
invokeTag('message','g',113,['code':("default.link.skip.label"),'default':("Skip to content&hellip;")],-1)
printHtmlPart(6)
...
invokeTag('ifLoggedIn','sec',126,[:],2)
printHtmlPart(10)
...
invokeTag('link','g',141,['controller':(c.logicalPropertyName)],3)
printHtmlPart(12)
}
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1405210334005L
