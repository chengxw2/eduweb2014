...
class gsp_eduweb2014_layoutsmain_gsp extends GroovyPage {
...
createTagBody(1, {->
printHtmlPart(10)
expressionOut.print(resource(dir: 'images', file: 'logotipo.png'))
printHtmlPart(11)
expressionOut.print(resource(dir: 'images', file: 'cuadradito_arriba.png'))
printHtmlPart(12)
...
public static final long LAST_MODIFIED = 1405048904555L
