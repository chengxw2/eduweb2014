	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.cursousuarios}">
				<li class="fieldcontain">
					<span id="cursousuarios-label" class="property-label"><g:message code="usuario.cursousuarios.label" default="Cursousuarios" /></span>
